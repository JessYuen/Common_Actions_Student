...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewShapes = new ViewShapes(); // top
        newShape = new NewShape(); // bottom
        ...
        //
        getSupportFragmentManager().beginTransaction() // VIEW SHAPES TOP LAYOUT
           .add(R.id.fragment_top, viewShapes, "viewFragment")
           .addToBackStack("viewFragment")
           .commit();

        getSupportFragmentManager().beginTransaction() // NEW SHARE BOTTOM LAYOUT
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_shape) {
            ...
            myMenu.getItem(2).setIcon(getResources().getDrawable(R.drawable.ic_eclipse_black, null));
            myMenu.getItem(3).setIcon(getResources().getDrawable(R.drawable.ic_chart_line_black, null));
            ...
            myMenu.getItem(0).setIcon(getResources().getDrawable(R.drawable.ic_circle_black, null));
            myMenu.getItem(1).setIcon(getResources().getDrawable(R.drawable.ic_square_black, null));
            myMenu.getItem(2).setIcon(getResources().getDrawable(R.drawable.ic_eclipse_white, null));
            myMenu.getItem(3).setIcon(getResources().getDrawable(R.drawable.ic_chart_line_black, null));
            ...
            myMenu.getItem(1).setIcon(getResources().getDrawable(R.drawable.ic_square_black, null));
            myMenu.getItem(2).setIcon(getResources().getDrawable(R.drawable.ic_eclipse_black, null));
            myMenu.getItem(3).setIcon(getResources().getDrawable(R.drawable.ic_chart_line_white, null));
        } else if (id == R.id.draw_line) {
            selectedShapeDrawing = "Freehand";
            myMenu.getItem(0).setIcon(getResources().getDrawable(R.drawable.ic_circle_black, null));
            myMenu.getItem(1).setIcon(getResources().getDrawable(R.drawable.ic_square_black, null));
            myMenu.getItem(2).setIcon(getResources().getDrawable(R.drawable.ic_eclipse_black, null));
            myMenu.getItem(3).setIcon(getResources().getDrawable(R.drawable.ic_chart_line_black, null));
